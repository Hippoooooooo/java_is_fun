...
public class Patient{
    ...
    public static void main( String[] args )
    {
        ...
        System.out.println("The first patient is " + patient.getFirstName() + " " + patient1.getLastName());
        System.out.println("The second patient is " + patient.getFirstName() + " " + patient2.getLastName());
    }
