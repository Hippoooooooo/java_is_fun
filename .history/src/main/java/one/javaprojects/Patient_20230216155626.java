...
public class Patient{
    ...
    public static void main( String[] args )
    {
        ...
        if(patient.isEmpty());{System.out.println("There is no patients waiting today.");}
        else {for(int i = 0;i <= patient.size(); i++);
            System.out.println("The patients awaiting now are : "  + patient.get(i).getFirstName() +patient.get(i).getLastName());
        }
}
} 
